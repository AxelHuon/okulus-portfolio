...
const HomeHero = () => {
	...
	useEffect(() => {
		gsap.to(imgRef.current, { opacity: 1 , transition : 0.3 , filter : "blur(0px)", scale:1, ease : Expo.easeIn });
	});
	...
	return (
		<div className={"home-hero"}>
			<div className={"home-hero-container"}>
				...
				<Tween from={{y: '100px', opacity: "0", rotate: 20}} to={{y: '0', opacity: "100%", rotate: 0}} ease="expo.in()" duration={1.4} stagger={0.15}>
					<SplitChars
						wrapper={<span/>}
					>
							Okulus
