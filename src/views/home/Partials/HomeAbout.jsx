...
// Exécution de la fonction toutes les secondes
	...
	return (
		<section data-scroll data-scroll-section data-scroll-offset={"200"} className={"home-about"}>
		<div className={"home-about-container"}>
			<div className={"home-about-container-text"}>
				<h3 data-scroll data-scroll-speed={"1"} className={"color-white regular text-120"}>
					<Tween playState={playState} from={{y: '100px', opacity: "0", rotate: 20}} to={{y: '0', opacity: "100%", rotate: 0}}
						   ease="expo.out()"
				...
				<p data-scroll data-scroll-speed={"-2"} data-scroll-direction={"horizontal"}
				   className={"paragraph text-20 color-white"}>Hi there! I'm a 20-year-old French painter who is
